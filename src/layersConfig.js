...
const layersConfig = {
  amountOfMoney: {
    ...
    legend: { "type": "", "buckets": [{ "literal":"0$ - 100$", "color":"rgb(223,253,251)", border:"#BCEEEA"},{ "literal":"100$ - 500$", "color":"rgb(143,188,196)", border:"#88B8BD"},{ "literal":"500$ - 1000$", "color":"rgb(91,135,153)", border:"#4F8593"},{ "literal":"1000$ - 1000000$", "color":"rgb(34,50,58)", border:"#182B31"}] }
  },
  donorsNumber: {
    ...
    legend: { "type": "", "buckets": [{ "literal":"0 to 50", "color":"#e3efc2", border:""},{ "literal":"50 to 250", "color":"rgb(207,230,141)", border:""},{ "literal":"250 to 1500", "color":"rgb(167,198,93)", border:""},{ "literal":"1500 to 3000", "color":"rgb(127,150,57)", border:""},{ "literal":"3000 to 376008", "color":"rgb(61,88,16)", border:""}] }
  },
  projects: {
    title: 'projects',
    ...
    legend: { "type": "", "buckets": [{ "literal":"<50% women and girls reached", "color":"rgb(201,200,182)", border:"rgb(201,200,182)"},{ "literal":">50% women and girls reached", "color":"rgb(240,213,104)", border:"#ecb931"}] }
  }
}
